# FEISTEL_IPID — unpredictable packet identifiers (secondary control for T5)

Article-grounded control (Gilad & Herzberg 2013) for the reassembly-collision
attack **T5**. It is a **secondary** control: the reliable defence for the live
T5 attack is **SAVI** (see [`../SAVI/`](../SAVI/)). This control addresses only
...
variable (roughly 0-60%). The live T5 attack in this testbed is reliably closed
