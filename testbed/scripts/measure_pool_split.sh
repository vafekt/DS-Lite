...
# and floods the identity-multiplication attack (T6) so it egresses on the FIRST
...
echo "================================================================"
echo "  Per-address NAT-pool split under T6 (two public IPv4 on the AFTR)"
echo "================================================================"
...
echo "  flooding T6 (forged softwire identities, inner src in B4-1 LAN -> egress .1) ..."
...
echo
echo "  ---------------- per-address pool split (T6) ----------------"
